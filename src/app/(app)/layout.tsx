...
// Client component for the loading bar
function LoadingBar() {
  "use client";
  ...
  // Inner component to safely call useSettings
  const BarContent = () => {
  ...
  return (
    <SettingsProvider>
      <SidebarProvider defaultOpen={false} collapsible="icon">
        <AppExitHandler />
        <div className="flex flex-col h-screen bg-background"> {/* Main container for the entire app view */}
          <div className="flex flex-1 h-full min-h-0 overflow-hidden"> {/* This flex row holds Sidebar and Content Area. min-h-0 and overflow-hidden are crucial */}
            ...
            <div className="flex flex-col flex-1 min-h-0"> {/* This is the column for Header + Scrollable Content. min-h-0 is crucial */}
